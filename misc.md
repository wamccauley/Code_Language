...
5. [Create a Column Based on Another Column in SQL](sql-column-like-another-column.md)
6. [Duplicated a Table and a Column in SQL](sql-table-column-duplicate.md)